...
def argument_parser():
    ...
    #                     help='root path to data directory')  '/home/Panmt/Vehicle/data', '/proj/Panmt'
    parser.add_argument('--root', type=str, default='/home/Panmt/Vehicle/data',
    ...
    # parser.add_argument('--GCN_learning_rate', default=0.0002, type=float,
    #                     help='initial learning rate')
    ...
    parser.add_argument('--lambda-xent', type=float, default=0.4,
                        help='weight to balance cross entropy loss')
    parser.add_argument('--lambda-htri', type=float, default=0.2,
                        help='weight to balance hard triplet loss')
    parser.add_argument('--lambda-LSTM', type=float, default=0.4,
                        help='weight to balance LSTM loss')
    # ************************************************************
    # Architecture
    # ************************************************************
    ...
    # Test settings
    # ************************************************************
    # parser.add_argument('--kp-ckpt', type=str, default='',
    #                     help='load kp_net weights ')
    ...
    parser.add_argument('--test_size', type=int, default=2400,
