...
class RandomIdentitySampler(Sampler):
    ...
    def __init__(self, data_source, batch_size, num_instances):
        ...
        self.num_pids_per_batch = self.batch_size // self.num_instances   # 100/10
        self.index_dic = defaultdict(list)
        # img, pid, camid, img_path, image_224, image_56, pose, keypoint
        ...
        for pid in self.pids:
            ...
            for idx in idxs:
                ...
                if len(batch_idxs) == self.num_instances:
                    batch_idxs_dict[pid].append(batch_idxs)  # {1: [10 idx], [10 ids]}
                    batch_idxs = []
